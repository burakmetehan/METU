...
\input{sections/2.1-dfa.tex}

\input{sections/2.2-nfa.tex}

\input{sections/2.3-fa-and-re.tex}

\input{sections/2.4-languages-regular-or-not.tex}

\input{sections/2.5-state-minimization-book.tex}

\input{sections/equivalence-relation-class.tex}
