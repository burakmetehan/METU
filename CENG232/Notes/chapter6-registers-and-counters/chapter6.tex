...
\input{sections/6.1-registers.tex}

\input{sections/6.2-shift-registers.tex}

\input{sections/6.3-ripple-counters.tex}

\input{sections/6.4-synchronous-counters.tex}

\input{sections/6.5-other-counters.tex}
