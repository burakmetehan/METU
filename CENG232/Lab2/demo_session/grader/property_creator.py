...
def execute(row: list) -> str: # One row of the truth table
    ...
    elif op_code == '001': # No such op_code in demo_session
        return ""
    ...
    if res > 3: # res cannot be shown, it shouldn't be include since it cannot be tested
        return ""
